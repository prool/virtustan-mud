...
а я распространяю код и мир свободно.
...
здесь https://mud.kharkov.org/files/windows7-binaries/virtustan-mud/
...
пакета cygwin, который в целом похож на Линукс. Или при помощи WSL (Windows subsystem Linux), которая есть,
начиная с версий Windows 10/11.
...
Кодовая таблица KOI-8RU может быть нужна, если вы планируете делать свои мад-зоны на украинском
