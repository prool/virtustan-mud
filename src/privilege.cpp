...
// TEST_BUILD означает "упрощенную сборку", в частности, там не обрабатывается файл privilege.lst,
// в котором разным иммам даются разные привилегии (доступ к разным группам иммовских команд).
// В упрощенном маде просто все иммы 34 уровня имеют доступ ко всем имм-командам
// В среде Цигвин обычно собираются именно такие версии
//
